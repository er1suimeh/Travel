...
const state = reactive({
  ecosystem: [
    { text: "vuetify-loader", href: "https://github.com/vuetifyjs/vuetify-loader/tree/next" },
    { text: "github", href: "https://github.com/vuetifyjs/vuetify/tree/next" },
  ...
  whatsNext: [
    ...
    { text: "Roadmap", href: "https://vuetifyjs.com/introduction/roadmap/" },
    { text: "Frequently Asked Questions", href: "https://vuetifyjs.com/getting-started/frequently-asked-questions" },
  ],
})

const { ecosystem, importantLinks, whatsNext } = toRefs(state)
</script>
